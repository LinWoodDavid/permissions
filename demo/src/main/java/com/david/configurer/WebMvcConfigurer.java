...
import com.david.core.ServiceException;
...
public class WebMvcConfigurer extends WebMvcConfigurationSupport {
    ...
    public void addResourceHandlers(ResourceHandlerRegistry registry) {
        ...
        /**
         *  将/favicon.ico 映射到 /static/favicon.ico
         *  解决找不到spring小叶子警告:
         *  WARN  PageNotFound            - No mapping for GET /favicon.ico
         */
    ...
    /**
     * 结果注入接口为null问题
     * 拦截器使用@Autowired注入接口为null
     * 让SecurityInterceptor Bean提前加载解决此问题
     *
     * @return
     */
    @Bean
